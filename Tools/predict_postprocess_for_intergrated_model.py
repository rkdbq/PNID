...
dt_json_filepath = "C:\\Users\\rkdbg\\Downloads\\results.bbox.json"  # prediction 결과로 mmdetection에서 생성된 json 파일 경로
output_dir = "D:\\Experiments\\Recognitions\\results.bbox.json_detection\\"  # 출력 파일들이 저장될 폴더
